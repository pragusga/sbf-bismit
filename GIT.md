...
* Lalu kamu harus membuka **semua file html** yang menggunakan css dan gambar untuk menyesuaikan dengan penulisan Django.
  Format dari django menggunakan **static**, jadi harus menambahkan {% raw %} {% load static %} {% endraw %}  di semua file yang menggunakan resource dari folder **static/** pada bagian paling atas. Contohnya seperti ini:
  ```html
  <!DOCTYPE html>
  { % load static % }
  <html lang="en">
